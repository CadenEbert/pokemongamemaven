...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        String[] greatball = { "Ivysaur", "Charmeleon", "Wartortle", "Metapod", "Kakuna", "Pidgeotto", "Raticate",
                "Spearow", "Arbok", "Raichu", "Sandslash", "Nidorina", "Nidorino", "Clefable", "Ninetales",
                "Wigglytuff", "Golbat", "Gloom", "Parasect", "Venomoth", "Dugtrio", "Persian", "Golduck", "Primeape",
                "Raichu", "Sandslash", "Nidorina", "Nidorino" };
